...
const achievements = [
  ...
  },
  {
    ...
    details: "At JP Morgan I made a back end data integrity application that could be applied to several clients.",
  },
  {
  ...
  {
    title: "Mentorship 💡",
    details: "In university I mentored 10+ students as a mentor and I was also a class rep for 2 years",
  },
];
  ...
  return (
    <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6 my-12">
      {achievements.map((ach, idx) => (
        <div
          key={idx}
          className="relative bg-white dark:bg-gray-800 rounded-lg shadow-md p-6 cursor-pointer transition-transform transform hover:scale-105 border border-gray-200 dark:border-gray-700 group"
        >
